...
<body>
    ...
    <main class="container my-5">
        <section id="best-sellers">
            <h2 class="text-center mb-4">پنل مدیریت</h2>
    <?php
...
<p>
    <a href="kalamanager_add.php">افزودن محصول</a>
</p>
    <div class="row g-4">
        <!-- محصول ۱ -->
        <?php
           ...
           <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card h-100 product-card">
                ...
                <div class="card-footer bg-transparent">
                    <button><a href="kalamanager_delete.php?id=<?php echo($row["id"]); ?>">حذف محصول</a></button>
                    <button><a href="kalamanager_edit.php?id=<?php echo($row["id"]); ?>">ویرایش محصول</a></button>
                </div>
            </div>
        </div> 
